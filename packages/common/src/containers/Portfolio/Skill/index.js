  ...
  return (
    <Box {...sectionWrapper} as="section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          <Heading {...secTitle} content="Ways I can contribute" />
          <Text
            {...secDescription}
            content="Have a look, some could be interesting to contribute towards the success of your company... Yes, that one!"
          />
        </Box>
